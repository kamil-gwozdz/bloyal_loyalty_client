...
# Unit tests for BloyalLoyaltyClient::PaymentInfo
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PaymentInfo' do
  before do
    # run before each test
    @instance = BloyalLoyaltyClient::PaymentInfo.new
  end
  ...
  describe 'test an instance of PaymentInfo' do
    it 'should create an instance of PaymentInfo' do
      expect(@instance).to be_instance_of(BloyalLoyaltyClient::PaymentInfo)
    end
  end
