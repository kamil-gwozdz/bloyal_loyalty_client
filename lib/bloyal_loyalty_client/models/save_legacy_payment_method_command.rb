...
module BloyalLoyaltyClient
  class SaveLegacyPaymentMethodCommand
    attr_accessor :customer_uid

    attr_accessor :payment_method_uid
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BloyalLoyaltyClient::SaveLegacyPaymentMethodCommand` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BloyalLoyaltyClient::SaveLegacyPaymentMethodCommand`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'payment_method_uid')
        self.payment_method_uid = attributes[:'payment_method_uid']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          payment_method_uid == o.payment_method_uid &&
          title == o.title &&
    ...
    def hash
      [customer_uid, payment_method_uid, title, is_primary, payment_type, credit_card, gift_card, device_uid, store_code, device_code, cashier_uid, cashier_code, cashier_external_id, uid, reference_number, system_uid, connector_uid].hash
    end
