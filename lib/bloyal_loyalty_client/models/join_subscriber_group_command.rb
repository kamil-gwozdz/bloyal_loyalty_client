...
module BloyalLoyaltyClient
  class JoinSubscriberGroupCommand
    attr_accessor :membership_uid

    attr_accessor :customer_uid

    attr_accessor :subscriber_group_uid
    ...
    def self.attribute_map
      {
        ...
        :'subscriber_group_uid' => :'SubscriberGroupUid',
        :'created' => :'Created',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BloyalLoyaltyClient::JoinSubscriberGroupCommand` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BloyalLoyaltyClient::JoinSubscriberGroupCommand`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'subscriber_group_uid')
        self.subscriber_group_uid = attributes[:'subscriber_group_uid']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          subscriber_group_uid == o.subscriber_group_uid &&
          created == o.created &&
    ...
    def hash
      [membership_uid, customer_uid, subscriber_group_uid, created, created_local, device_uid, store_code, device_code, cashier_uid, cashier_code, cashier_external_id, uid, reference_number, system_uid, connector_uid].hash
    end
