  ...
  class AccrualSummary
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BloyalLoyaltyClient::AccrualSummary` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BloyalLoyaltyClient::AccrualSummary`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'referred_by_uid')
        self.referred_by_uid = attributes[:'referred_by_uid']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          referred_by_uid == o.referred_by_uid &&
    ...
    def hash
      [cart_uid, customer_uid, referred_by_uid, sponsor_uid, loyalty_points_accruals, loyalty_points_redemptions, loyalty_currency_accruals].hash
    end
