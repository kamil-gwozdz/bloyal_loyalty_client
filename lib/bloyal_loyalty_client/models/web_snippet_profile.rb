...
module BloyalLoyaltyClient
  class WebSnippetProfile
    attr_accessor :customer_dashboard

    attr_accessor :customer_referral

    attr_accessor :record_engagement

    attr_accessor :club_signup
    ...
    def self.openapi_types
      {
        :'customer_dashboard' => :'Object',
        :'customer_referral' => :'Object',
        :'record_engagement' => :'Object',
        :'club_signup' => :'Object',
        :'login' => :'Object',
        :'signup' => :'Object',
        :'uid' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BloyalLoyaltyClient::WebSnippetProfile` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BloyalLoyaltyClient::WebSnippetProfile`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'customer_dashboard')
        self.customer_dashboard = attributes[:'customer_dashboard']
      end

      if attributes.key?(:'customer_referral')
        self.customer_referral = attributes[:'customer_referral']
      end

      if attributes.key?(:'record_engagement')
        self.record_engagement = attributes[:'record_engagement']
      end

      if attributes.key?(:'club_signup')
        self.club_signup = attributes[:'club_signup']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          customer_dashboard == o.customer_dashboard &&
          customer_referral == o.customer_referral &&
          record_engagement == o.record_engagement &&
          club_signup == o.club_signup &&
          login == o.login &&
          signup == o.signup &&
          uid == o.uid &&
          revision == o.revision &&
    ...
    def hash
      [customer_dashboard, customer_referral, record_engagement, club_signup, login, signup, uid, revision, external_id, code, name, is_valid, type, theme, title, message, on_success_redirect_url, on_success_message, on_success_redirect_delay, login_type, login_snippet_code, login_url].hash
    end
