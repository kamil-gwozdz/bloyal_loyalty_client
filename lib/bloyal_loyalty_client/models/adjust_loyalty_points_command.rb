...
module BloyalLoyaltyClient
  class AdjustLoyaltyPointsCommand
    ...
    attr_accessor :account_class_uid
    ...
    def self.attribute_map
      {
        ...
        :'comment' => :'Comment',
        :'account_class_uid' => :'AccountClassUid',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BloyalLoyaltyClient::AdjustLoyaltyPointsCommand` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BloyalLoyaltyClient::AdjustLoyaltyPointsCommand`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'account_class_uid')
        self.account_class_uid = attributes[:'account_class_uid']
      end
    ...
    def valid?
      source_validator = EnumAttributeValidator.new('Object', ['Undefined', 'SalesTransaction', 'Club', 'SubscriberGroup', 'LoyaltyProgram', 'Engagement'])
    ...
    def source=(source)
      validator = EnumAttributeValidator.new('Object', ['Undefined', 'SalesTransaction', 'Club', 'SubscriberGroup', 'LoyaltyProgram', 'Engagement'])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          comment == o.comment &&
          account_class_uid == o.account_class_uid &&
    ...
    def hash
      [customer_uid, points, created_local, created, source, source_uid, source_external_id, reason_code, comment, account_class_uid, device_uid, store_code, device_code, cashier_uid, cashier_code, cashier_external_id, uid, reference_number, system_uid, connector_uid].hash
    end
