...
module BloyalLoyaltyClient
  class InactivateClubMembershipCommand
    attr_accessor :membership_uid
    ...
    attr_accessor :enable_loyalty_benefits_while_inactive
    ...
    def self.attribute_map
      {
        ...
        :'enable_loyalty_benefits_while_inactive' => :'EnableLoyaltyBenefitsWhileInactive',
    ...
    def self.openapi_types
      {
        :'membership_uid' => :'Object',
        :'customer_uid' => :'Object',
        :'club_uid' => :'Object',
        :'activation_date' => :'Object',
        :'enable_loyalty_benefits_while_inactive' => :'Object',
        :'device_uid' => :'Object',
        :'store_code' => :'Object',
        :'device_code' => :'Object',
        :'cashier_uid' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BloyalLoyaltyClient::InactivateClubMembershipCommand` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BloyalLoyaltyClient::InactivateClubMembershipCommand`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'membership_uid')
        self.membership_uid = attributes[:'membership_uid']
      end
      ...
      if attributes.key?(:'enable_loyalty_benefits_while_inactive')
        self.enable_loyalty_benefits_while_inactive = attributes[:'enable_loyalty_benefits_while_inactive']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          membership_uid == o.membership_uid &&
          customer_uid == o.customer_uid &&
          club_uid == o.club_uid &&
          activation_date == o.activation_date &&
          enable_loyalty_benefits_while_inactive == o.enable_loyalty_benefits_while_inactive &&
    ...
    def hash
      [membership_uid, customer_uid, club_uid, activation_date, enable_loyalty_benefits_while_inactive, device_uid, store_code, device_code, cashier_uid, cashier_code, cashier_external_id, uid, reference_number, system_uid, connector_uid].hash
    end
