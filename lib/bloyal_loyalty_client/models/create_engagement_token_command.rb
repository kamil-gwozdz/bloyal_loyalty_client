...
module BloyalLoyaltyClient
  class CreateEngagementTokenCommand
    ...
    attr_accessor :engagement_type_code

    attr_accessor :engagements_allowed
    ...
    def self.attribute_map
      {
        ...
        :'engagement_type_code' => :'EngagementTypeCode',
        :'engagements_allowed' => :'EngagementsAllowed',
    ...
    def self.openapi_types
      {
        ...
        :'engagement_type_code' => :'Object',
        :'engagements_allowed' => :'Object',
        :'expiration' => :'Object',
        :'device_uid' => :'Object',
        :'store_code' => :'Object',
        :'device_code' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BloyalLoyaltyClient::CreateEngagementTokenCommand` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BloyalLoyaltyClient::CreateEngagementTokenCommand`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'engagement_type_code')
        self.engagement_type_code = attributes[:'engagement_type_code']
      end

      if attributes.key?(:'engagements_allowed')
        self.engagements_allowed = attributes[:'engagements_allowed']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          engagement_type_code == o.engagement_type_code &&
          engagements_allowed == o.engagements_allowed &&
    ...
    def hash
      [customer_uid, customer_external_id, customer_code, engagement_type_uid, engagement_type_code, engagements_allowed, expiration, device_uid, store_code, device_code, cashier_uid, cashier_code, cashier_external_id, uid, reference_number, system_uid, connector_uid].hash
    end
