...
module BloyalLoyaltyClient
  class RecordEngagementTokenCommand
    attr_accessor :engagement_token
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BloyalLoyaltyClient::RecordEngagementTokenCommand` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BloyalLoyaltyClient::RecordEngagementTokenCommand`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'engagement_token')
        self.engagement_token = attributes[:'engagement_token']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          engagement_token == o.engagement_token &&
          quantity == o.quantity &&
          message == o.message &&
    ...
    def hash
      [engagement_token, quantity, message, device_uid, store_code, device_code, cashier_uid, cashier_code, cashier_external_id, uid, reference_number, system_uid, connector_uid].hash
    end
