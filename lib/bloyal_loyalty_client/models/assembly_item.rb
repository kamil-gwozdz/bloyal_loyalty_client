...
module BloyalLoyaltyClient
  class AssemblyItem
    ...
    attr_accessor :assembly_product_uid
    ...
    def self.attribute_map
      {
        :'uid' => :'Uid',
        :'assembly_product_uid' => :'AssemblyProductUid',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BloyalLoyaltyClient::AssemblyItem` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BloyalLoyaltyClient::AssemblyItem`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'assembly_product_uid')
        self.assembly_product_uid = attributes[:'assembly_product_uid']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          uid == o.uid &&
          assembly_product_uid == o.assembly_product_uid &&
    ...
    def hash
      [uid, assembly_product_uid, product_uid, product_code, product_external_id, product_name, quantity, weight, price, cost, pricing, discount_details, order_discount, tax_exempt, tax_details].hash
    end
