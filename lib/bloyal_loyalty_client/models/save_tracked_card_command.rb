...
module BloyalLoyaltyClient
  class SaveTrackedCardCommand
    attr_accessor :tracked_card_uid
    ...
    def self.attribute_map
      {
        :'tracked_card_uid' => :'TrackedCardUid',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BloyalLoyaltyClient::SaveTrackedCardCommand` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BloyalLoyaltyClient::SaveTrackedCardCommand`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'tracked_card_uid')
        self.tracked_card_uid = attributes[:'tracked_card_uid']
      end
      ...
      if attributes.key?(:'provider_uid')
        self.provider_uid = attributes[:'provider_uid']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          tracked_card_uid == o.tracked_card_uid &&
          tracking_key == o.tracking_key &&
          external_id == o.external_id &&
          provider_uid == o.provider_uid &&
    ...
    def hash
      [tracked_card_uid, tracking_key, external_id, provider_uid, provider_code, device_uid, store_code, device_code, cashier_uid, cashier_code, cashier_external_id, uid, reference_number, system_uid, connector_uid].hash
    end
