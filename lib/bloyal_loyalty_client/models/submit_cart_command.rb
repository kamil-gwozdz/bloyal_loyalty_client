...
module BloyalLoyaltyClient
  class SubmitCartCommand
    ...
    attr_accessor :generate_transaction

    attr_accessor :generate_alerts

    attr_accessor :generate_orders
    ...
    def self.openapi_types
      {
        :'cart' => :'Object',
        :'generate_transaction' => :'Object',
        :'generate_alerts' => :'Object',
        :'generate_orders' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BloyalLoyaltyClient::SubmitCartCommand` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BloyalLoyaltyClient::SubmitCartCommand`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'generate_transaction')
        self.generate_transaction = attributes[:'generate_transaction']
      end

      if attributes.key?(:'generate_alerts')
        self.generate_alerts = attributes[:'generate_alerts']
      end

      if attributes.key?(:'generate_orders')
        self.generate_orders = attributes[:'generate_orders']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          cart == o.cart &&
          generate_transaction == o.generate_transaction &&
          generate_alerts == o.generate_alerts &&
          generate_orders == o.generate_orders &&
    ...
    def hash
      [cart, generate_transaction, generate_alerts, generate_orders, order_processor, device_uid, store_code, device_code, cashier_uid, cashier_code, cashier_external_id, uid, reference_number, system_uid, connector_uid].hash
    end
