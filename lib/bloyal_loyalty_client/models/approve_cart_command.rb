...
module BloyalLoyaltyClient
  class ApproveCartCommand
    ...
    attr_accessor :bypass_compliance_checks
    ...
    def self.attribute_map
      {
        ...
        :'bypass_compliance_checks' => :'BypassComplianceChecks',
        :'cart' => :'Cart',
    ...
    def self.openapi_types
      {
        ...
        :'bypass_compliance_checks' => :'Object',
        :'cart' => :'Object',
        :'device_uid' => :'Object',
        :'store_code' => :'Object',
        :'device_code' => :'Object',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `BloyalLoyaltyClient::ApproveCartCommand` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `BloyalLoyaltyClient::ApproveCartCommand`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'bypass_compliance_checks')
        self.bypass_compliance_checks = attributes[:'bypass_compliance_checks']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          bypass_compliance_checks == o.bypass_compliance_checks &&
          cart == o.cart &&
    ...
    def hash
      [cart_uid, cart_external_id, cart_source_external_id, order_processor, bypass_compliance_checks, cart, device_uid, store_code, device_code, cashier_uid, cashier_code, cashier_external_id, uid, reference_number, system_uid, connector_uid].hash
    end
